...
export default class Skill extends React.Component {
    ...
    saveSkill() {
        ...
        if (skill.name == null || skill.level == null || skill.name == '' || skill.level == '') {
            ...
            $.ajax({
                url: 'https://talentmvpservicesprofile.azurewebsites.net/profile/profile/addSkill',
                headers: {
    ...
    loadData() {
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentmvpservicesprofile.azurewebsites.net/profile/profile/getSkill',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
    ...
    updateSkill(currentSkill) {
        if (currentSkill.skill == null || currentSkill.experienceLevel == null || currentSkill.skill == '' || currentSkill.experienceLevel == '') {
            ...
            var cookies = Cookies.get('talentAuthToken');
            $.ajax({
                url: 'https://talentmvpservicesprofile.azurewebsites.net/profile/profile/updateSkill',
                headers: {
                    'Authorization': 'Bearer ' + cookies,
                    'Content-Type': 'application/json'
                },
    ...
    deleteSkill() {
        ...
        var cookies = Cookies.get('talentAuthToken');
        $.ajax({
            url: 'https://talentmvpservicesprofile.azurewebsites.net/profile/profile/deleteSkill',
            headers: {
                'Authorization': 'Bearer ' + cookies,
                'Content-Type': 'application/json'
            },
